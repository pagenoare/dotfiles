...
hi LineNr guifg=#808080 guibg=#141414 gui=bold
...
hi Constant guifg=#cf6a4c gui=bold
hi String guifg=orange gui=bold,italic
"hi String guifg=#ddf2a4

hi Identifier guifg=#7587a6 gui=bold
" Type
hi Structure guifg=#9B859D gui=bold
hi Function guifg=#dad085 gui=bold
" dylan: method, library, ...
hi Statement guifg=#dad085 gui=bold
" Keywords
hi PreProc guifg=#cda869 gui=bold
"gui=underline
